              ...
              children: [
                Padding(
                  padding: EdgeInsets.only(
                      top: 11.sp, left: 22.sp, bottom: 11.sp, right: 9.sp),
                  child: CircleAvatar(
                    radius: 23,
                    backgroundImage: CachedNetworkImageProvider(
                        'https://images.unsplash.com/photo-1658828911730-ffe8fd2e4aed?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=776&q=80'),
                  ),
                ),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
