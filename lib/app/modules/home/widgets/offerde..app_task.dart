    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                taskHeading,
                style: isCompleted==true ? TextStyle(
                  fontSize: 15.sp,
                  fontWeight: FontWeight.w600,
        ...
        Padding(
          ...
          child: Text(
              taskSubHeading,
              style:isCompleted == true ? TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w500,decoration: TextDecoration.lineThrough):TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w500)
          ),
        ),
      ],
    );
